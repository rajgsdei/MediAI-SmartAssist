...
urlpatterns = [
    ...
    path('users/<uuid:user_id>/edit/', user_management_views.edit_user, name='edit_user'),
    path('users/<uuid:user_id>/view/', user_management_views.view_user, name='view_user'),
